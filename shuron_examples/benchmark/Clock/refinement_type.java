...
public class Clock {
  ...
  //@def_type Legal_Secs = {int v | 0 <= v < SECS_IN_MIN}
  //@def_type Legal_Mins = {int v | 0 <= v < MINS_IN_HOUR}
  //@def_type Legal_Hours = {int v | 0 <= v < HOURS_IN_DAY}
  ...
  //@ public model int refienement_type Legal_Hours hours;
  ...
  //@ public model int refienement_type Legal_Mins minutes;
  ...
  //@ public model int refienement_type Legal_Secs seconds;
  ...
  public Clock(final int /*`@refienement_type Legal_Hours*/ the_hours, final int /*`@refienement_type Legal_Mins*/ the_minutes, final int /*`@refienement_type Legal_Secs*/ the_seconds) {
    my_hours = the_hours;
  ...
  //@ signals_only \nothing;
  protected void setHours(final int /*`@refienement_type Legal_Hours*/ the_hours) {
    my_hours = the_hours;
  }
  ...
  //@ signals_only \nothing;
  protected void setMinutes(final int /*`@refienement_type Legal_Mins*/ the_minutes) {
    my_minutes = the_minutes;
  }
  ...
  //@ signals_only \nothing;
  protected void setSeconds(final int /*`@refienement_type Legal_Secs*/ the_seconds) {
    my_seconds = the_seconds;
  }
